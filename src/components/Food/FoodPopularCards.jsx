  ...
  return (
    <>
      {props.strCategory !== "Breakfast" && props.strCategory !== "Goat" && (
        <Link
          to={`/foods/${props.strCategory}`}
          className="w-[13%] p-6  rounded-full gap-4 shadow-xl flex flex-col items-center hover:scale-105 hover:bg-sky-100 transition-all cursor-pointer justify-center"
        >
